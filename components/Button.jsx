    ...
    <>
      {loading ? (
        <span className="flex items-center gap-2">
          ...
          <span className="group-hover:text-bg transition-colors duration-300">
            Processing...
          </span>
        </span>
      ) : (
        <>
          {Icon && (
            <Icon className="w-5 h-5 group-hover:text-bg transition-colors duration-300" />
          )}
          <span className="uppercase tracking-tighter group-hover:text-bg transition-colors duration-300">
            {text}
          </span>
        </>
      )}
