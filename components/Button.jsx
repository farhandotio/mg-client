...
export default function Button({
  ...
  const baseClasses = `
    ...
    text-text whitespace-nowrap rounded-md transition-all duration-500 w-full cursor-pointer disabled:opacity-70 bg-border border ${fillColor} md:bg-border max-md:text-white border-border/20 
