          ...
          <div className="max-w-4xl mx-auto h-full flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar">
              <div className="flex items-center gap-4 mb-6">
                <p className="text-pText/40 text-[12px] font-medium uppercase tracking-tighter whitespace-nowrap">
                ...
                {products.length > 0
                        ...
                        >
                          <div className="w-20 h-20 bg-bg rounded-0 border border-border/10 flex items-center justify-center shrink-0 overflow-hidden">
                            <img
                              ...
                              alt={product.title}
                              className="w-full h-full object-cover rounded-0 group-hover:scale-110 transition-transform duration-500"
                            />
                          </div>
                  ...
                  : !loading && (
                      <div className="col-span-full text-center py-20 opacity-30 italic">
                        <p className="text-pText font-medium uppercase tracking-tighter text-sm">
