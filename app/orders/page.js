        ...
        <div className="space-y-6 flex-1">
          <div className="flex items-start justify-between md:justify-start md:gap-6">
            <div>
              ...
              <h4 className="text-sm font-medium text-text font-mono">
                #{order._id.toUpperCase()}
              </h4>
            </div>
            <div
              className={`px-4 py-1.5 rounded-full border text-[11px] font-medium uppercase tracking-tighter ${
          ...
          <div className="flex flex-wrap gap-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[11px] font-medium text-pText uppercase">অর্ডার সময়</p>
