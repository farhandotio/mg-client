    ...
    <div className="min-h-screen bg-bg text-text py-12 selection:bg-primary selection:text-bg">
      <div className="max-w-7xl px-5 md:px-6 mx-auto space-y-10">
        ...
        <div ref={componentRef} className="print:p-10 print:bg-white print:text-black">
          {/* হেডার কার্ড */}
          <div className="bg-card/30 rounded-xl p-8 md:p-16 border border-border/30 relative overflow-hidden shadow-2xl">
                ...
                {order.orderItems?.map((item, idx) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h4 className="text-[13px] font-black uppercase text-text">{item.title}</h4>
                        <p className="text-[11px] text-pText font-bold uppercase">
                          পরিমাণ: {item?.quantity}
                        </p>
                      </div>
                    </div>
                    <p className="text-md font-black font-mono text-primary italic">
        ...
        <div className="flex justify-center pb-10">
          <div className="text-[9px] font-bold text-pText/70 uppercase tracking-wide text-center">
