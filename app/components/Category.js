      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-4">
          ...
          <Link
            ...
            className="group flex items-center gap-3 text-[10px] font-black uppercase tracking-[0.3em] text-pText hover:text-primary transition-all bg-card/50 px-4 py-2 rounded-full border border-border/50"
          >
            Access All Units
