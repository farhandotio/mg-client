...
import Image from 'next/image'; // Fix: Next.js Image component
...
export default function Hero() {
  return (
    <section className="relative w-full min-h-150 bg-bg flex items-center py-10 px-6 max-w-7xl mx-auto overflow-hidden">
      ...
      <div className="absolute top-[-10%] right-[-5%] w-125 h-125 bg-primary/10 blur-[120px] rounded-full -z-10 pointer-events-none select-none" />
      <div className="absolute bottom-[-10%] left-[-5%] w-100 h-100 bg-secondary/10 blur-[100px] rounded-full -z-10 pointer-events-none select-none" />
      ...
      <div className="flex justify-between w-full max-md:flex-wrap gap-16 items-center">
        ...
        >
          ...
          <div className="md:w-fit">
            <Button
              arialabel="Explore our shop products"
              url="/shop"
              size="lg"
              icon={ArrowRight}
              text="Explore Shop"
        ...
        <motion.div
          ...
          className="relative flex justify-end items-center w-full md:w-1/2"
        >
          {/* Decorative Circles */}
          <div className="absolute w-[110%] aspect-square border border-border/10 rounded-full animate-[spin_20s_linear_infinite] will-change-transform pointer-events-none" />
          ...
          <div className="relative z-10 w-full max-w-md aspect-square bg-card border border-border/50 rounded-[3rem] p-3 shadow-2xl overflow-hidden group">
            <div className="relative h-full w-full bg-bg rounded-[2.5rem] overflow-hidden flex flex-col items-center justify-center border border-white/5">
              ...
              {/* Product Image Container - Fixed Positioning */}
              <div className="relative w-full h-full flex items-center justify-center p-12">
                <div className="relative w-full h-full">
                  <Image
                    ...
                    className="object-contain transition-transform duration-700 group-hover:scale-110 group-hover:-translate-y-6 will-change-transform"
                  />
                </div>
              </div>
              ...
              <div className="absolute bottom-6 inset-x-6 z-20">
                <div className="bg-card/90 backdrop-blur-xl border border-border/50 p-5 rounded-3xl flex justify-between items-center shadow-lg">
                  <div>
                    <p className="text-[10px] font-black text-primary uppercase tracking-tighter">
                      Featured Hardware
                    </p>
                    <h3 className="text-text font-black text-xl italic tracking-tighter leading-none">
                      Apple Watch Pro
                    </h3>
                  </div>
                  <Link
                    ...
                    className="bg-primary text-bg p-3 rounded-2xl hover:scale-110 transition-transform active:scale-95"
                  >
