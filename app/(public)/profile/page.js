          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="space-y-4">
              {addresses?.length > 0 ? (
                ...
                <div className="text-center py-12 bg-card/20 rounded-0 border border-dashed border-border/40">
            ...
            {isEditModalOpen && (
              <form onSubmit={handleUpdateProfile} className="space-y-6">
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-3">
                      ...
                      {/* Preview Box */}
                      <div className="w-12 h-12 rounded-0 bg-bg border border-border flex items-center justify-center overflow-hidden shrink-0">
                        {editData.image ? (
                          <img
                            src={editData.image}
                            alt="preview"
                ...
                <Button
                  ...
                  className="w-full py-4 rounded-0 mt-4"
                  disabled={loading}
                />
              </form>
            )}
            ...
            {isAddressModalOpen && (
              <form onSubmit={handleAddressSubmit} className="space-y-6">
                ...
                <Button
                  ...
                  className="w-full py-4 rounded-0"
                  disabled={loading}
                />
              </form>
            )}
