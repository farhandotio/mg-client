  ...
  const columns = [
    {
      ...
      render: (item) => (
        <div className="flex flex-col gap-1">
          <span className="text-[10px] font-mono text-secondary/70 font-medium uppercase">
            #{item._id?.slice(-8)}
          </span>
    ...
    },
    {
      ...
      key: 'totalPrice',
      render: (item) => (
        <span className="font-medium text-secondary text-xs italic">
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 relative">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
        <div>
          ...
          <h1 className="text-4xl lg:text-5xl font-medium uppercase italic tracking-tighterer text-text leading-none mt-1">
            অর্ডার <span className="text-secondary">তালিকা</span>
          </h1>
        </div>
      ...
      <div className="relative group">
        <div className="absolute -inset-1 bg-secondary/5 rounded-0 blur-xl opacity-0 group-hover:opacity-100 transition duration-1000"></div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-300">
          <div className="bg-card border border-border w-full max-w-md rounded-0 p-8  relative">
            <button
              aria-label="close"
            ...
            <h2 className="text-2xl font-medium italic uppercase tracking-tighterer mb-1">
              Update <span className="text-secondary">Status</span>
            </h2>
            ...
            <div className="space-y-6">
              <select
                ...
                className="w-full bg-bg rounded-0 border border-border px-4 py-3 text-xs font-medium text-text focus:border-secondary outline-none appearance-none"
              >
              ...
              <button
                ...
                className="w-full bg-secondary hover:bg-secondary/80 text-black font-medium uppercase italic py-4 rounded-0 transition-all text-xs tracking-tighter"
              >
                আপডেট করুন
              </button>
            </div>
