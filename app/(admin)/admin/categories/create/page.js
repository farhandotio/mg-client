            ...
            <div className="space-y-6 grow flex flex-col relative z-10">
              <div className="relative group/input">
                <input
                  ...
                  className="w-full border border-border/80 rounded-md p-4 bg-bg/60 text-[12px] font-bold uppercase tracking-widest outline-none focus:border-primary focus:ring-4 focus:ring-primary/5 transition-all shadow-inner"
                />
                ...
                <div className="grid grid-cols-2 gap-4">
                  {['active', 'inactive'].map((status) => (
                    <button
                      ...
                      className={`group relative overflow-hidden py-5 rounded-md border-2 font-black text-[12px] uppercase tracking-widest transition-all 
                      ${
