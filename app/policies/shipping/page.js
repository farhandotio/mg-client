    ...
    <main className="pt-20 md:pt-24 pb-20 bg-bg min-h-screen">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 mb-20 border-b border-bg/5 pb-12">
          ...
          <div className="p-6 bg-secondary text-bg rounded-0 flex items-center gap-4 shadow-[0_20px_40px_rgba(var(--secondary-rgb),0.2)]">
        ...
        <div className="space-y-12">
          <div className="space-y-6">
            <h3 className="text-2xl font-medium text-text uppercase italic border-b border-secondary/20 pb-4">
          ...
          <div className="p-10 bg-card/20 border border-bg/5 rounded-0 text-center space-y-4">
...
function ZoneCard({ location, time, price, detail }) {
  return (
    <div className="p-10 bg-card/20 border border-bg/5 rounded-0 hover:bg-card/40 transition-all duration-500">
      ...
      <div className="space-y-4">
        <div className="flex gap-4">
          <span className="text-[12px] font-medium uppercase bg-secondary/10 text-secondary px-3 py-1 rounded-full">
            {time}
          </span>
...
function ProtocolItem({ icon, text }) {
  return (
    <div className="flex items-center gap-4 p-5 bg-bg/20 rounded-0 border border-bg/5">
