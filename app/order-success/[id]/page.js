    ...
    return (
      <div className="min-h-screen bg-bg flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-primary font-black tracking-[0.3em] text-[12px] animate-pulse uppercase">
            Syncing Neural Data...
          </p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <p className="text-pText text-[12px] font-black tracking-[0.4em] uppercase italic">
            ...
            <div className="bg-card/50 backdrop-blur-xl border border-border rounded-lg overflow-hidden group">
              ...
              <div className="p-8">
                <div className="flex flex-wrap justify-between items-start gap-4 mb-10">
                  <div>
                    <h3 className="text-pText text-[11px] font-black uppercase tracking-[0.2em] mb-2 flex items-center gap-2">
                  ...
                  <div className="text-right">
                    <h3 className="text-pText text-[11px] font-black uppercase tracking-[0.2em] mb-2">
                      Status
                    </h3>
                    <span className="px-3 py-1 bg-primary text-bg text-[12px] font-black rounded-full italic uppercase">
            ...
            <div className="bg-card border border-border rounded-lg p-8 sticky top-24">
                ...
                {orderDetails.orderItems?.map((item, idx) => (
                  <div key={idx} className="flex justify-between items-start gap-4 group">
                    <div className="flex-1">
                      ...
                      <p className="text-[12px] text-pText font-black mt-1">QTY: {item.quantity}</p>
                    </div>
              ...
              <div className="space-y-3 pt-6 border-t border-dashed border-border">
                ...
                <div className="flex justify-between items-center pt-6 mt-2 border-t border-border">
                  <span className="text-[12px] font-black uppercase text-pText">Total Payable</span>
...
function SectionLabel({ icon: Icon, text }) {
  return (
    <div className="flex items-center gap-2">
      ...
      <h3 className="text-pText text-[11px] font-black uppercase tracking-[0.2em]">{text}</h3>
    </div>
  );
}
