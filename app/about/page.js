        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            ...
            <p className="text-pText leading-loose italic">
              My Gadget was founded in 2020 with a simple idea: everyone deserves access to premium
          ...
          {/* Values Grid */}
          <div className="bg-card border border-border p-8 md:p-12 rounded-[2.5rem] grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              {
      ...
      <section className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="text-pText font-medium italic opacity-80">
            The passionate people behind My Gadget who make it all happen.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {team.map((member, i) => (
            <div
              key={i}
              className="bg-card border border-border p-10 rounded-2xl flex flex-col items-center text-center group hover:border-primary transition-all duration-300"
            >
